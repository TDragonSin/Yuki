var top_exit = document.getElementById("J_event_close");
var top_ad = document.getElementsByClassName("most_top")[0];
top_exit.onclick = function(){
  top_move(top_ad,{opacity:0},function(){
...
function top_move(ele,json,callback){
  if(move.moving){
      move.stop();
  }
  ele.timer = {}
